...
if (s2[s2_index] == '*')
{
return (_wildcmp_helper(s1, s2, s1_index, s2_index + 1) ||
(s1[s1_index] != '\0' && _wildcmp_helper(s1 + 1, s2, s1_index + 1, s2_index)));
}

if (s1[s1_index] == s2[s2_index])
return (_wildcmp_helper(s1 + 1, s2 + 1, s1_index + 1, s2_index + 1));
